...
<body>
	...
	<div id="icon">
		...
		<ul id="icon3">
			...
			<li id="search"><input type="text" onblur=" sousuo()"/><input type="button" value="影片搜索" width="10px"/>
		</ul>
		</div>
	...
	<div id="paixing" class="" >
		<p style="color:white;background-color:#3a90d1;height:32px;text-align: center;font-size: 30px;margin-bottom: 1px">影片排行榜</p>
...
<div id="link" style="font-size: 20px">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;联系我们
		<img id="shoukuan" src="images-cover/shoukuan.png">
	</div>
<div id="top">
		<a id="dingbu" href="#">置顶</a>
</div>
